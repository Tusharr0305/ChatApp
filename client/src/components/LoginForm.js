      ...
      <form onSubmit={handleLogin}>
        <div className="field is-grouped is-grouped-centered">
          <div className="control">
            <input value={fullName} onChange={(e) => setFullName(e.target.value)} className="input" type="text" placeholder="Name" required="required" autoFocus={true} />
            <p className={"help is-danger" + (loginMessage == null ? " is-hidden" : "")}>{loginMessage}</p>
          </div>

          <div className="control">
            <input className="button" type="submit" value="Get Into Room" />
          </div>
        </div>
      </form>
    </div>
